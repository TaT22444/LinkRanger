...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: '#18181B', borderRadius: 12, marginHorizontal: 20, padding: 16, maxHeight: '45%', borderWidth: 1, borderColor: 'rgba(139, 92, 246, 0.3)' },
  modalTitle: { fontSize: 16, fontWeight: 'bold', color: '#FFF', marginBottom: 16 },
  ...
  // Untagged items
  untaggedItemContainer: { backgroundColor: 'rgba(167, 139, 250, 0.05)' },
